...
{
    return i2c_slave_write(DS3231_I2C_DEF_ADDRESS, data, len);
}
...
{
    return i2c_slave_read(DS3231_I2C_DEF_ADDRESS, data[0], data, len);
}
...
bool ds3231_getOscillatorStopFlag(bool *flag)
{
    ...
    if (ds3231_getFlag(DS3231_ADDR_STATUS, DS3231_STATUS_OSF, &f)) {
        *flag = (f ? true : false);
        return true;
    }
...
{
    return ds3231_setFlag(DS3231_ADDR_STATUS, DS3231_STATUS_OSF, DS3231_CLEAR);
}
...
{
    return ds3231_setFlag(DS3231_ADDR_STATUS, DS3231_STATUS_32KHZ, DS3231_SET);
}

inline bool ds3231_disable32khz()
{
    return ds3231_setFlag(DS3231_ADDR_STATUS, DS3231_STATUS_32KHZ, DS3231_CLEAR);
}
