...
#define OW_PIN_NOPULLUP() gpio_set_pull_mode(OW_PIN_NUM, GPIO_FLOATING)
#define OW_GET_IN()   gpio_get_level(OW_PIN_NUM)
#define OW_OUT_LOW()  gpio_set_level(OW_PIN_NUM, 0)
#define OW_OUT_HIGH() gpio_set_level(OW_PIN_NUM, 1)
#define OW_DIR_OUT()  gpio_set_direction(OW_PIN_NUM, GPIO_MODE_OUTPUT)
#define OW_DIR_IN()   gpio_set_direction(OW_PIN_NUM, GPIO_MODE_INPUT)
